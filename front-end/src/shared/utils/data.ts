...
export const brandData: IBrandData[] = [
  ...
  { src: '/biosystems.png', alt: 'Biosystems Logo', name: 'Biosystems' },
  { src: '/canon.png', alt: 'Canon Logo', name: 'Canon' },
  { src: '/hitachi.avif', alt: 'Hitachi Logo', name: 'Hitachi' },
  { src: '/olympus.jpg', alt: 'Olympus Logo', name: 'Olympus' },
  { src: '/villa.jpeg', alt: 'Villa Logo', name: 'Villa' },
  { src: '/vinno.png', alt: 'Vinno Logo', name: 'Vinno' },
];
